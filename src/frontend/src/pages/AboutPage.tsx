      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-20">
          ...
          <p className="text-lg lg:text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed animate-fade-in-up animate-delay-100">
            Where luxury meets legacy. We are dedicated to providing exceptional
            real estate experiences that transcend expectations and create
            lasting value.
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="fade-in-on-scroll opacity-0">
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                <p>
                  Founded with a vision to redefine luxury real estate,
                  Crownstone Realty has become synonymous with excellence,
                  trust, and discretion in the high-end property market.
                </p>
                <p>
                  Our journey began with a simple belief: that every client
                  deserves not just a property, but a legacy. We've built our
                  reputation on understanding the unique needs of discerning
                  clients and delivering exceptional results that exceed
                  expectations.
                </p>
                <p>
                  Today, we stand as a trusted partner for those seeking the
                  finest properties in the world's most prestigious locations.
                  Our commitment to excellence, combined with our deep market
                  knowledge and extensive network, ensures that we deliver
